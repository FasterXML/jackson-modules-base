...
public class RecordBasicsTest extends BaseMapTest
{
  ...
  static final class RecordAllWriteOnly extends RecordTag {
    ...
    public void notestDeserializeJsonRename() throws Exception {
     ...
     */
    public void notestDeserializeHeaderInjectRecord_WillFail() throws Exception {
    ...
    public void notestDeserializeJsonDeserializeRecord() throws Exception {
