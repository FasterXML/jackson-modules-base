...
public class CoerceToBooleanTest extends BlackbirdTestBase
{
    ...
    private final ObjectMapper DEFAULT_MAPPER = newBlackbirdMapper();
    ...
    private final ObjectMapper MAPPER_INT_TRY_CONVERT = blackbirdMapperBuilder()
            .withCoercionConfig(LogicalType.Boolean, cfg ->
                cfg.setCoercion(CoercionInputShape.Integer, CoercionAction.TryConvert))
            .build();

    private final ObjectMapper MAPPER_INT_TO_NULL = blackbirdMapperBuilder()
            .withCoercionConfig(LogicalType.Boolean, cfg ->
                cfg.setCoercion(CoercionInputShape.Integer, CoercionAction.AsNull))
            .build();

    private final ObjectMapper MAPPER_TO_FAIL = blackbirdMapperBuilder()
            .withCoercionConfig(LogicalType.Boolean, cfg ->
