package tools.jackson.module.blackbird.deser.jdk;
    ...
    extends BlackbirdTestBase
{
    ...
    public void testDoubleAsArray() throws Exception
    {
        ...
        try {
            ...
            verifyException(exp, "Unexpected token (`JsonToken.VALUE_NUMBER_FLOAT`");
        }
    ...
    public void testSequenceOfInts() throws Exception
    {
        ...
        ObjectMapper mapper = blackbirdMapperBuilder()
