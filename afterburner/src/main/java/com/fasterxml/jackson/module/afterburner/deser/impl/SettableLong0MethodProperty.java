...
public final class SettableLong0MethodProperty
    extends OptimizedSettableBeanProperty<SettableLong0MethodProperty>
{
    private static final long serialVersionUID = 1L;

    public SettableLong0MethodProperty(SettableBeanProperty src,
    ...
    protected SettableBeanProperty withDelegate(SettableBeanProperty del) {
        return new SettableLong0MethodProperty(del, _propertyMutator, _optimizedIndex);
    }

    @Override
    public SettableBeanProperty withMutator(BeanPropertyMutator mut) {
        return new SettableLong0MethodProperty(delegate, mut, _optimizedIndex);
    }
            ...
            Object bean) throws IOException
    {
        ...
        try {
            _propertyMutator.longSetter0(bean, v);
        } catch (Throwable e) {
