...
public class CoerceToBooleanTest extends AfterburnerTestBase
{
    ...
    private final ObjectMapper MAPPER_INT_TRY_CONVERT = afterburnerMapperBuilder()
            .withCoercionConfig(LogicalType.Boolean, cfg ->
                cfg.setCoercion(CoercionInputShape.Integer, CoercionAction.TryConvert))
            .build();

    private final ObjectMapper MAPPER_INT_TO_NULL = afterburnerMapperBuilder()
            .withCoercionConfig(LogicalType.Boolean, cfg ->
